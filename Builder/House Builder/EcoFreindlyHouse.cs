...
namespace Builder.House_Builder
{
    public class EcoFreindlyHouse : IHouseBuilder
    {
        ...
        public void FlooringType(string flooringType = "Bamboo")
        {
        ...
        public void KitchenStyle(string kitchenStyle = "Eco")
        {
            _house.KitchenStyle = kitchenStyle;
        }
        public void Garden(bool garden = false)
        {
            _house.Garden = garden;
        }
        public void SwimmingPool(bool swimmingPool = false)
        {
